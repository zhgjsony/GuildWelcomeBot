...
`GuildWelcomeBot` 是一款魔兽世界正式服公会辅助插件，提供**自动迎新**与**右键快捷招人**功能。

### 主要功能
* **自动迎新**：新人入会时自动发送欢迎语。支持自定义延迟时间，支持 `{name}` 名字占位符（自动去服务器后缀）。
...
`GuildWelcomeBot` is a lightweight WoW Retail guild assistant addon for **auto-welcoming** and **quick recruitment**.
